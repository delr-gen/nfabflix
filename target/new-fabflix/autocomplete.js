...
function handleLookup(query, doneCallback) {
    ...
    cachedData = localStorage.getItem(query)
    if (cachedData) {
        console.log("retrieving suggest list from cache");
...
function handleSelectSuggestion(suggestion) {
	...
	document.location.href =  `single-movie.html?movieId=${suggestion["data"]["id"]}`;
}
...
function handleNormalSearch(query) {
    document.location.href =  `movies.html?title=${query}&year=&director=&star=`;
}